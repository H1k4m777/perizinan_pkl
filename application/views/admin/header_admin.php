		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Daerah kecamatan:</h6>
						<a class="collapse-item" href="">Banyumanik</a>
						<a class="collapse-item" href="">Candisari</a>
						<a class="collapse-item" href="">Gajahmungkur</a>
						<a class="collapse-item" href="">Gayamsari</a>
						<a class="collapse-item" href="">Genuk</a>
						<a class="collapse-item" href="">Gunungpati</a>
			...
			<li class="nav-item">
				...
				<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">List Perizinan:</h6>
						<a class="collapse-item" href="<?= base_url('admin/ajuan'); ?>">Daftar Ajuan</a>
						<a class="collapse-item" href="<?= base_url('admin/disetujui'); ?>">Ajuan Yang Disetujui</a>
					</div>
				</div>
			</li>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								<img class="img-profile rounded-circle" src="<?= base_url('sbadmin/'); ?>img/default.png">
							</a>
